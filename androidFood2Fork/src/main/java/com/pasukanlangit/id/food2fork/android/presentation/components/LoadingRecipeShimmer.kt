...
import androidx.compose.ui.unit.dp
import com.pasukanlangit.id.food2fork.android.presentation.recipelist.components.ShimmerRecipeCardItem
        ...
        LazyColumn {
            items(repeatCount){
                ShimmerRecipeCardItem(
                    ...
                    padding = padding,
                    repeatItemBar = repeatItemBarCount
                )
            }
        }
    }
